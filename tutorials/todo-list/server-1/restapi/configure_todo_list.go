...
import (
	...
	"mygithub/Goswagger-Sample/tutorials/todo-list/server-1/models"
	"mygithub/Goswagger-Sample/tutorials/todo-list/server-1/restapi/operations"
	"mygithub/Goswagger-Sample/tutorials/todo-list/server-1/restapi/operations/todos"
)
